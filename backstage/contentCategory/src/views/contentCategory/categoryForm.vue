  ...
  <div class="dr-AdminResourceForm">
    ...
    >
      ...
      >
        ...
        <el-form-item :label="$t('contentCategory.type')" prop="cate_type">
          <el-radio
            class="radio"
            v-model="dialogState.formData.cate_type"
            label="1"
        ...
        <el-form-item
          ...
          prop="contentTemp"
        >
          <el-select size="small" v-model="dialogState.formData.content_temp" placeholder="请选择">
            <el-option
