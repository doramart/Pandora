<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="help_type" :label="$t('helpCenter.type')">
        <template slot-scope="scope">
          <span v-if="scope.row.help_type == '0'">普通</span>
          <span v-if="scope.row.help_type == '1'">其它</span>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="createdAt" :label="$t('helpCenter.time')"></el-table-column>
      <el-table-column prop="updatedAt" :label="$t('helpCenter.updateTime')"></el-table-column>
