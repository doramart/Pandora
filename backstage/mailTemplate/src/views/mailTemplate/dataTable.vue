<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="temp_type" :label="$t('mailTemplate.type')">
        <template slot-scope="scope">
          <span>{{ mailTemplateTypeList[scope.row.temp_type] }}</span>
        </template>
      </el-table-column>

      <el-table-column
        prop="comment"
        :label="$t('mailTemplate.comment')"
      ></el-table-column>

      <el-table-column
        prop="title"
        :label="$t('mailTemplate.title')"
      ></el-table-column>

      <el-table-column
        prop="createdAt"
        :label="$t('mailTemplate.createTime')"
      ></el-table-column>
