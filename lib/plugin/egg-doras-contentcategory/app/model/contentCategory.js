 ...
 * @Last Modified time: 2021-03-26 11:48:12
 */
'use strict';

const moment = require('moment');
module.exports = (app) => {
  const { DATE, STRING, BOOLEAN, INTEGER, VIRTUAL } = app.Sequelize;
  const ContentCategory = app.model.define(
    'content_category',
    {
      id: {
        type: INTEGER,
      ...
      parentId: {
        ...
        defaultValue: 0,
        get() {
          return Number(this.getDataValue('parentId'));
        },
      },
      enable: {
        // 是否公开 默认公开
      ...
      content_temp: { type: INTEGER, allowNull: true },
      defaultUrl: {
        type: STRING,
